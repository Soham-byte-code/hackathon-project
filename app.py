...
# Fill defaults
suppliers.fillna({
    'fuel_cost_per_km': 6.5,         # ~₹100/litre, ~15 km/litre
    'co2_per_km': 0.15,              # 150g/km typical
    'spoilage_rate_per_km': 0.001,   # 0.1% per km
...
if st.button("🚀 Get AI Decision"):
    ...
    if matched.empty:
        ...
        spoilage_kg = round(dist * best['spoilage_rate_per_km'] * qty_needed, 2)
